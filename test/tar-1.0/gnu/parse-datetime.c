...
{
       0,   594,   594,   595,   599,   607,   609,   613,   618,   623,
     628,   633,   638,   643,   648,   652,   656,   663,   667,   671,
     676,   681,   686,   690,   695,   700,   707,   709,   713,   738,
     740,   750,   752,   754,   759,   764,   767,   769,   774,   779,
     784,   790,   799,   804,   837,   845,   853,   858,   864,   869,
     875,   879,   889,   891,   893,   898,   900,   902,   904,   906,
     908,   910,   913,   916,   918,   920,   922,   924,   926,   928,
     930,   932,   934,   936,   938,   940,   944,   946,   948,   951,
     953,   955,   960,   964,   964,   967,   968,   974,   975,   981,
     986,   997,   998
};
#endif
...
#line 1877 "parse-datetime.c"
    break;

  case 23: /* iso_8601_time: tUNUMBER zone_offset  */
#line 691 "parse-datetime.y"
      {
        set_hhmmss (pc, (yyvsp[-1].textintval).value, 0, 0, 0);
        pc->meridian = MER24;
      }
...
#line 1919 "parse-datetime.c"
    break;

  case 30: /* local_zone: tLOCAL_ZONE tDST  */
#line 741 "parse-datetime.y"
      {
        pc->local_isdst = 1;
        pc->dsts_seen++;
      }
#line 1928 "parse-datetime.c"
    break;
...
#line 2005 "parse-datetime.c"
    break;

  case 41: /* day: tUNUMBER tDAY  */
#line 791 "parse-datetime.y"
      {
...
#line 2140 "parse-datetime.c"
    break;

  case 53: /* rel: relunit  */
#line 892 "parse-datetime.y"
      { if (! apply_relative_time (pc, (yyvsp[0].rel), 1)) YYABORT; }
#line 2146 "parse-datetime.c"
    break;

  case 54: /* rel: dayshift  */
#line 894 "parse-datetime.y"
      { if (! apply_relative_time (pc, (yyvsp[0].rel), 1)) YYABORT; }
#line 2152 "parse-datetime.c"
    break;
...
#line 999 "parse-datetime.y"
      { (yyval.intval) = (yyvsp[0].textintval).value; }
#line 2360 "parse-datetime.c"
    break;


#line 2364 "parse-datetime.c"
